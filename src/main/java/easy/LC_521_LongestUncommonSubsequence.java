...
the order of the remaining elements. Trivially, any string is a subsequence of itself and an empty string is
...
public class LC_521_LongestUncommonSubsequence {

    /*
    Bad question, word game, no need to explain
     */
    public int findLUSlength(String a, String b) {
        if(a.length() == b.length()) {
            if(allCharactersSame(a, b)) {
                return -1;
            } else {
                return a.length() - 1;
            }
    ...
    private boolean allCharactersSame(String a, String b) {
