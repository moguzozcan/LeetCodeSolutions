...
public class LC_155_MinStack {
    ...
    /**
     * The idea in this question is to create a new data structure type, and store the current minimum
     * of the all values with them. Then return the min of the current value.
