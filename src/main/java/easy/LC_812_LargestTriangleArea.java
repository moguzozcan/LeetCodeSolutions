...
public class LC_812_LargestTriangleArea {
    ...
    /*
    This is not a good question I guess, I will just give the solution.
    Intuition
    ...
    If we did not know the shoelace formula, we could derive it for triangles with the following approach: starting with
    points (px, py), (qx, qy), (rx, ry), the area of this triangle is the same under a translation by (-rx, -ry), so that
    the points become (px-rx, py-ry), (qx-rx, qy-ry), (0, 0).
